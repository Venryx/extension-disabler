	...
	if (popup) {
      ...
      .getAll(function getAllExtensions(extensions) {
		...
		chrome.tabs.getSelected(function (tab) {
			...
			var setURL = document.getElementById('siteURL');
			//setURL.outerHTML = '<input type = text id = "siteURL" value =' + domainUrl[2] + '/>';
			setURL.value = domainUrl[2];
		});
		...
		enterButton.addEventListener("click", function (event) {
			...
			var filterWords = document.getElementById("siteURL").value;
